...
{
public:
    typedef function<GComponent*(TreeNode* node)> TreeNodeCreateCellFunction;
    typedef function<void(TreeNode* node)> TreeNodeRenderFunction;
    typedef function<void(TreeNode* node, bool expand)> TreeNodeWillExpandFunction;
    ...
    void getSelection(vector<TreeNode*>& result) const;
