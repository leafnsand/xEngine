...
void RelationItem::addRefTarget(GObject* target)
{
    ...
    if (target != _owner->_parent)
        target->addEventListener(UIEventType::PositionChange, FUI_CALLBACK_1(RelationItem::onTargetXYChanged, this), EventTag(this));
    target->addEventListener(UIEventType::SizeChange, FUI_CALLBACK_1(RelationItem::onTargetSizeChanged, this), EventTag(this));
