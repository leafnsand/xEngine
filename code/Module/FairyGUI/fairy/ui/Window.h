...
class IUISource : public Ref
{
public:
    virtual const AZStd::string& getFileName() = 0;
    virtual void setFileName(const AZStd::string& value) = 0;
    virtual bool isLoaded() = 0;
    virtual void load(function<void()> callback) = 0;
};

class Window : public GComponent
{
    FUI_RTTI_DERIVED(Window, GComponent)
public:
    Window();
    virtual ~Window();
