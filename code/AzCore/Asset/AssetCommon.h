...
#if defined(AZ_PLATFORM_LINUX) || defined(AZ_PLATFORM_ANDROID) || defined(AZ_PLATFORM_APPLE) || defined(AZ_PLATFORM_EMSCRIPTEN)
    ...
    namespace Data
    {
        ...
        public:
            ...
            */
            ...
            bool Create(const char* path, bool queueLoad = false);
        ...
        */
        ...
        bool Asset<T>::Load()
        {
            ...
            if (m_assetData)
            {
                *this = AssetInternal::AssetLoad(m_assetData);
            }
        ...
        bool Asset<T>::Create(const AssetId& id, bool queueLoad)
        {
            if (id != GetId())
            {
                ...
                *this = AssetInternal::GetAsset(id, m_assetType, queueLoad);
        ...
        //=========================================================================
        template<class T>
        bool Asset<T>::Create(const char* path, bool queueLoad)
        {
            if (path && path[0])
            {
                const AZ::u8 loadFlags = GetFlags();
                ...
                // Acquire new asset. This will release the current asset.
                *this = AssetInternal::GetAsset(path, m_assetType, queueLoad);
