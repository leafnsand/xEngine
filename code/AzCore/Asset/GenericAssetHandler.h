...
*
*/
#ifndef AZCORE_ASSET_GENERICASSETHANDLER_H
#define AZCORE_ASSET_GENERICASSETHANDLER_H
...
namespace AZ
{
    ...
    class AutoRegisterAssetHandler : public AZ::Data::AssetHandler
    {
    public:
        AZ_RTTI(AutoRegisterAssetHandler<AssetType>, "{EDCEA8DD-3F45-49BC-8E44-5B40A6FDAAB8}", AZ::Data::AssetHandler);

        AutoRegisterAssetHandler()
        {
            Register();
        }

        ~AutoRegisterAssetHandler() override
        {
            Unregister();
        }
    ...
    */
    ...
    public:
        ...
        GenericAssetHandler(AZ::SerializeContext* serializeContext = nullptr)
...
#endif // AZCORE_ASSET_GENERICASSETHANDLER_H
