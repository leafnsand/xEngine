...
namespace AZ
{
    ...
    void BehaviorEntity::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (auto behaviorContext = azrtti_cast<AZ::BehaviorContext*>(context))
        {
            ...
            behaviorContext->Class<BehaviorEntity>("Entity")
                ...
                ->Method("AddComponent", &BehaviorEntity::AddComponent)
                ->Method("SetRuntimeActive", &BehaviorEntity::SetRuntimeActive)
    ...
    AZ::EntityContextId BehaviorEntity::GetOwningContextId() const
    {
    ...
    bool BehaviorEntity::IsActivated() const
    {
        ...
        return (state == AZ::Entity::ES_ACTIVE || state == AZ::Entity::ES_ACTIVATING);
    }
    ...
    bool BehaviorEntity::AddComponent(AZ::Component& component)
    {
        AZ::Entity* entity;
        AZStd::string errorMessage;
        if (!GetValidEntity(&entity, nullptr, &errorMessage))
        {
            AZ_Warning("Entity", false, "Cannot add component. %s", errorMessage.c_str());
            return false;
        }
    ...
    void BehaviorEntity::SetRuntimeActive(bool runtimeActive)
    {
        AZ::Entity* entity;
        AZStd::string errorMessage;
        if (!GetValidEntity(&entity, nullptr, &errorMessage))
        {
            AZ_Warning("Entity", false, "Cannot SetRuntimeActive. %s", errorMessage.c_str());
            return;
        }
        entity->SetRuntimeActiveByDefault(runtimeActive);
    }
