...
namespace AZ
{
    ...
    void MathReflect(BehaviorContext& context)
    {
        ...
        context.Class<Crc32>()->
            ...
            Method("CreateCrc32", [](AZStd::string_view value) -> Crc32 { return Crc32(value.data()); }, { { { "value" } } })
            ;
