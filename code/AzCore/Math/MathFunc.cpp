...
namespace AZ
{
    ...
    AZ::Vector3 ConvertQuaternionToEulerRadians(const AZ::Quaternion& q)
    {
        ...
        return AZ::ConvertTransformToEulerRadians(transform);
    }
