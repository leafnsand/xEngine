...
#include <AzCore/Input/Buses/Requests/InputMotionSensorRequestBus.h>
#include <AzCore/Input/Channels/InputChannelAxis3D.h>
#include <AzCore/Input/Channels/InputChannelQuaternion.h>
...
namespace AZ
{
    ...
    public:
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::InputMotionSensorRequests::GetInputChannelEnabled
        bool GetInputChannelEnabled(const InputChannelId& channelId) override;

        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::InputMotionSensorRequests::SetInputChannelEnabled
        void SetInputChannelEnabled(const InputChannelId& channelId, bool enabled) override;

        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::ApplicationLifecycleEvents::OnApplicationSuspended
