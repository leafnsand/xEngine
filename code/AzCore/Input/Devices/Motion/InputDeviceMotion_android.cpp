...
namespace AZ
{
    ...
    private:
        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::InputDeviceMotion::Implementation::IsConnected
        bool IsConnected() const override;

        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::InputDeviceMotion::Implementation::TickInputDevice
        void TickInputDevice() override;

        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::InputDeviceMotion::Implementation::RefreshMotionSensors
        ...
        , m_motionSensorManager()
    {
        ...
        m_motionSensorManager.reset(aznew AZ::Android::JNI::Object("com/uuzu/n3h5app/input/MotionSensorManager"));
