...
namespace AZ
{
    ...
    private:
        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::InputDeviceVirtualKeyboard::Implementation::IsConnected
        bool IsConnected() const override;

        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::InputDeviceVirtualKeyboard::Implementation::HasTextEntryStarted
        bool HasTextEntryStarted() const override;

        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::InputDeviceVirtualKeyboard::Implementation::TextEntryStart
        void TextEntryStart(const InputTextEntryRequests::VirtualKeyboardOptions& options) override;

        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::InputDeviceVirtualKeyboard::Implementation::TextEntryStop
        void TextEntryStop() override;

        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::InputDeviceVirtualKeyboard::Implementation::TickInputDevice
        void TickInputDevice() override;

        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::RawInputNotificationsAndroid::OnRawInputTextEvent
        void OnRawInputTextEvent(const char* charsModifiedUTF8) override;

        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::RawInputNotificationsAndroid::OnRawInputVirtualKeyboardEvent
        ...
        : InputDeviceVirtualKeyboard::Implementation(inputDevice)
    {
        ...
        activity.RegisterMethod("GetKeyboardHandler", "()Lcom/uuzu/n3h5app/input/KeyboardHandler;");
        jobject keyboardRef = activity.InvokeObjectMethod<jobject>("GetKeyboardHandler");
        jclass keyboardClass = AZ::Android::JNI::LoadClass("com/uuzu/n3h5app/input/KeyboardHandler");
    ...
    void InputDeviceVirtualKeyboardAndroid::OnRawInputVirtualKeyboardEvent(int keyCode, int keyAction)
    {
        ...
        switch (keyCode)
        {
            ...
            {
                AZStd::lock_guard<AZStd::mutex> lock(m_threadAwareRawCommandEventsMutex);
                m_threadAwareRawCommandEvents.push_back(AZ::InputDeviceVirtualKeyboard::Command::NavigationBack);
            }
            break;
            case AKEYCODE_CLEAR:
            {
                AZStd::lock_guard<AZStd::mutex> lock(m_threadAwareRawCommandEventsMutex);
                m_threadAwareRawCommandEvents.push_back(AZ::InputDeviceVirtualKeyboard::Command::EditClear);
            }
            break;
            case AKEYCODE_ENTER:
            {
                AZStd::lock_guard<AZStd::mutex> lock(m_threadAwareRawCommandEventsMutex);
                m_threadAwareRawCommandEvents.push_back(AZ::InputDeviceVirtualKeyboard::Command::EditEnter);
            }
            break;
            case AKEYCODE_DEL:
            {
