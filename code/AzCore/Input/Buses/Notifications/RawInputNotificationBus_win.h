...
namespace AZ
{
    ...
    //! that want RawInput events to be processed by the AZ input system must broadcast all
    ...
    //!
    //! This EBus is intended primarily for the AZ input system to process win input events.
    //! Most systems that need to process input should use the generic AZ input interfaces,
