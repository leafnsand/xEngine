...
#elif defined(AZ_PLATFORM_APPLE) || defined(AZ_PLATFORM_LINUX) || defined(AZ_PLATFORM_EMSCRIPTEN)
#   define INVALID_SOCKET (-1)
#   define closesocket(_s)                          close(_s)
#   define GetInternalSocketError                   errno
typedef int SOCKET;
...
#if   defined(AZ_PLATFORM_ANDROID) || defined(AZ_PLATFORM_APPLE) || defined(AZ_PLATFORM_LINUX) || defined(AZ_PLATFORM_EMSCRIPTEN)
...
#error Platform not supported!
        ...
        {
#if   defined(AZ_PLATFORM_ANDROID) || defined(AZ_PLATFORM_LINUX) || defined(AZ_PLATFORM_EMSCRIPTEN)
