...
namespace AZ
{
    ...
    /*
     * struct to help with Additional data to be associated with parameters(Argument names, type traits and default values), these are usually in arrays
     */
    struct BehaviorParameterMetadata
    {
        BehaviorParameterMetadata(AZStd::string_view name = {}, BehaviorDefaultValue* defaultValue = {})
            : m_name(name)
    ...
    {
        BehaviorParameterOverrides(AZStd::string_view name = {}, BehaviorDefaultValue* defaultValue = {},
    ...
    */
    ...
    namespace Internal
    {
        ...
        public:
            ...
            AZStd::array<BehaviorParameterMetadata, sizeof...(Args)+s_startNamedArgumentIndex> m_metadataParameters; ///< Stores the per parameter metadata which is used to add names, trait, default values, etc... to the parameters
        };
...
#   define BehaviorConstant(value) []() { return value; }
    ...
    public:
        ...
        struct BusForwarderEvent
        {
            ...
            AZStd::vector<BehaviorParameterMetadata> m_metadataParameters; //< Custom Metadata for the parameter. Contains Names for each parameter.
    ...
    public:
        ...
        struct ClassBuilder : public Internal::GenericAttributes<ClassBuilder<C>>
        {
            ...
            */
            ...
            template<class Function>
            ClassBuilder* Method(const char* name, Function f, BehaviorValues* defaultValues = nullptr);

            template<class Function>
            ClassBuilder* Method(const char* name, Function f, const AZStd::array<BehaviorParameterOverrides, AZStd::function_traits<Function>::num_args>& args);
        ...
        struct EBusBuilder : public Internal::GenericAttributes<EBusBuilder<Bus>>
        {
            ...
            */
            template<class Function>
            EBusBuilder* Event(const char* name, Function f);
        ...
        template<class Function>
        GlobalMethodBuilder Method(const char* name, Function f, BehaviorValues* defaultValues = nullptr);

        template<class Function>
        GlobalMethodBuilder Method(const char* name, Function f, const AZStd::array<BehaviorParameterOverrides, AZStd::function_traits<Function>::num_args>& args);
        ...
        template<class T>
        EBusBuilder<T> EBus(const char* name);
...
#define AZ_BEHAVIOR_EBUS_MACRO_CALLER(macro, ...) AZ_BEHAVIOR_EXPAND(AZ_BEHAVIOR_EBUS_MACRO_CALLER_NEXT(__VA_ARGS__) (macro, __VA_ARGS__))
    ...
    void BehaviorEBusHandler::SetEvent(Event e, AZStd::string_view name, const AZStd::array<BehaviorParameterOverrides, AZStd::function_traits<Event>::num_args>& args)
    {
        ...
        if (i != -1)
        {
            ...
            {
                m_events[i].m_metadataParameters[AZ::eBehaviorBusForwarderEventIndices::ParameterFirst] = { args[argIndex].m_name };
            }
        }
    }
    ...
    BehaviorContext::ClassBuilder<T> BehaviorContext::Class(const char* name)
    {
        ...
        if (AzTypeInfo<T>::Uuid().IsNull())
        {
            AZ_Error("Reflection", false, "Class '%s' has not type info!", name);
    ...
    //////////////////////////////////////////////////////////////////////////
    template<class Function>
    BehaviorContext::GlobalMethodBuilder BehaviorContext::Method(const char* name, Function f, BehaviorValues* defaultValues)
    {
        ...
        return Method(name, f, parameterOverrides);
    }

    //////////////////////////////////////////////////////////////////////////
    template<class Function>
    BehaviorContext::GlobalMethodBuilder BehaviorContext::Method(const char* name, Function f, const AZStd::array<BehaviorParameterOverrides, AZStd::function_traits<Function>::num_args>& args)
    {
        if (IsRemovingReflection())
        {
    ...
    template<class C>
    template<class Function>
    BehaviorContext::ClassBuilder<C>* BehaviorContext::ClassBuilder<C>::Method(const char* name, Function f, BehaviorValues* defaultValues)
    {
        AZStd::array<BehaviorParameterOverrides, AZStd::function_traits<Function>::num_args> parameterOverrides;
        if (defaultValues)
        {
    ...
    template<class C>
    template<class Function>
    BehaviorContext::ClassBuilder<C>* BehaviorContext::ClassBuilder<C>::Method(const char* name, Function f, const AZStd::array<BehaviorParameterOverrides, AZStd::function_traits<Function>::num_args>& args)
    {
        if (m_class)
        {
            typedef Internal::BehaviorMethodImpl<typename AZStd::RemoveFunctionConst<typename AZStd::remove_pointer<Function>::type>::type> BehaviorMethodType;
    ...
    //////////////////////////////////////////////////////////////////////////
    template<class T>
    BehaviorContext::EBusBuilder<T> BehaviorContext::EBus(const char* name)
    {
    ...
    template<class Bus>
    template<class Function>
    BehaviorContext::EBusBuilder<Bus>* BehaviorContext::EBusBuilder<Bus>::Event(const char* name, Function e)
    {
        AZStd::array<BehaviorParameterOverrides, AZStd::function_traits<Function>::num_args> parameterOverrides;
        return Event(name, e, parameterOverrides);
    }
