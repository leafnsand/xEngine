    ...
    public:
        ...
        */
        ...
        struct EntityRestoreInfo
        {
            ...
            EntityRestoreInfo(const Data::Asset<SliceAsset>& asset, const SliceInstanceId& instanceId, const EntityId& ancestorId)
        ...
        public:
            ...
            InstantiatedContainer* GetInstantiated() const
            {
