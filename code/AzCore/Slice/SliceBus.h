...
#include <AzCore/Component/EntityContextBus.h>
...
namespace AZ
{
    ...
    */
    ...
    class SliceInstantiationNotification
        : public AZ::EBusTraits
    {
    public:
        ...
        virtual ~SliceInstantiationNotification() = default;

        virtual void OnSliceInstantiated(const AZ::EntityId& /*spawnedEntities*/) {}

        virtual void OnSliceInstantiationFailed() {}
    };

    using SliceInstantiationNotificationBus = AZ::EBus<SliceInstantiationNotification>;
} // namespace AZ