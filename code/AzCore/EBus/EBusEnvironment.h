...
namespace AZ
{
    ...
    namespace Internal
    {
        ...
        */
        ...
        private:
            ...
            size_t m_ebusEnvironmentTLSIndex;
    ...
    public:
        ...
        template<class Context>
        Context* GetBusContext(size_t tlsKey);
         ...
         */ 
        Internal::ContextBase* FindContext(size_t tlsKey);
         ...
         */
        bool InsertContext(size_t tlsKey, Internal::ContextBase* context, bool isTakeOwnership);
    ...
    //////////////////////////////////////////////////////////////////////////
    template<class Context>
    inline Context* EBusEnvironment::GetBusContext(size_t tlsKey)
    {
        Internal::ContextBase* context = FindContext(tlsKey);
        if (!context)
        {
