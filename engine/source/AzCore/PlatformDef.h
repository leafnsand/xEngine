...
#elif defined(AZ_PLATFORM_PS3) || defined(AZ_PLATFORM_PS4) || defined(AZ_PLATFORM_LINUX) || defined(AZ_PLATFORM_ANDROID) || defined(AZ_PLATFORM_APPLE) || defined(AZ_PLATFORM_EMSCRIPTEN) // ACCEPTED_USE
...
#elif defined(AZ_PLATFORM_LINUX) || defined(AZ_PLATFORM_EMSCRIPTEN)
