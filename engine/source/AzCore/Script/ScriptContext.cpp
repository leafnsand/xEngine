...
namespace AZ
{
    ...
    namespace Internal
    {
        ...
        //////////////////////////////////////////////////////////////////////////
        void LuaScriptValueStackPush(lua_State* lua, void* dataPointer, const AZ::Uuid* typeId)
        {
            if (typeId)
            {
                Internal::LuaClassToStack(lua, dataPointer, *typeId);
            }
            else
            {
        ...
        static int LuaSafeCallErrorHandler(lua_State* lua)
        {
            ...
            {
                AZ_Assert(false, "First argument to LuaSafeCallErrorHandler must be a string, not %s!", luaL_typename(lua, -1));
            }
        ...
        int Class__ToString(lua_State* l)
        {
            ...
            lua_rawgeti(l, -1, AZ_LUA_CLASS_METATABLE_NAME_INDEX); // load the class name for a better error);
...
#   pragma warning(pop)
        ...
        {
            luaL_error(l, "max value is %f, got %f", limits::max(), number);
        }
        if (number < limits::lowest())
        {
            luaL_error(l, "min value is %f, got %f", limits::max(), number);
        }
    ...
    //////////////////////////////////////////////////////////////////////////
    void ScriptValue<const VectorFloat>::StackPush(lua_State* l, float value)
    {
        lua_pushnumber(l, value);
    }

    //////////////////////////////////////////////////////////////////////////
    float ScriptValue<const VectorFloat>::StackRead(lua_State* l, int stackIndex)
    {
        return azlua_checknumber<float>(l, stackIndex);
    }
...
#include <AzCore/RTTI/AttributeReader.h>
    ...
    namespace AZ
    {
        ...
        namespace Internal
        {
            ...
            void RegisteredObjectToLua(lua_State* lua, void* value, const AZ::Uuid& typeId, bool passByValue)
            {
                LSV_BEGIN(lua, 1);
                ...
                bool isCacheInstance = true;
                size_t valueSize = 0;
                if (passByValue || storageType == Script::Attributes::StorageType::Value)
                {
            ...
            struct LuaScriptReflectedType
            {
                ...
                static void ToStack(lua_State* lua, BehaviorValueParameter& value)
                {
                    ...
                    {
                        passByValue = (value.m_traits & BehaviorParameter::TR_REFERENCE) == 0; // references are passed by pointer
                    }

                    RegisteredObjectToLua(lua, valueAddress, value.m_typeId, passByValue);
                }
                static bool FromStack(LuaLoadFromStack& arg, LuaPrepareValue* prepareValue = nullptr)
                {
                    arg = &FromStack;
                    if (prepareValue)
                    {
            ...
            void  LuaClassToStack(lua_State* lua, void* valueAddress, const AZ::Uuid& typeId)
            {
                RegisteredObjectToLua(lua, valueAddress, typeId, false);
            }
        ...
        LuaLoadFromStack FromLuaStack(BehaviorContext* context, const BehaviorParameter* param, LuaPrepareValue* prepareParam, BehaviorClass*& behaviorClass)
        {
            LuaLoadFromStack result = nullptr;
            behaviorClass = nullptr;
            // handle integral types
            if (Internal::LuaScriptNumber<bool>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<short>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<AZ::s64>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<long>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<unsigned char>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<unsigned short>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<unsigned int>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<AZ::u64>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<unsigned long>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<float>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<double>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<int>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptString::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<char>::FromStack(param, result, prepareParam)) return result;
            else if (Internal::LuaScriptNumber<VectorFloat>::FromStack(param, result, prepareParam)) return result;
            ...
            else
            {
                ...
                else
                {
                    ...
                    Internal::LuaScriptReflectedType::FromStack(result, prepareParam);
                }
            ...
            {
                Internal::LuaScriptGenericPointer::FromStack(param, result, prepareParam);
            }
        ...
        LuaPushToStack ToLuaStack(BehaviorContext* context, const BehaviorParameter* param, LuaPrepareValue* prepareParam, BehaviorClass*& behaviorClass)
        {
            ...
            else if (Internal::LuaScriptNumber<VectorFloat>::ToStack(param, result, prepareParam)) return result;
        ...
        public:
            ...
            LuaGenericCaller(BehaviorContext* context, BehaviorMethod* method)
            {
                ...
                if (method->GetNumArguments() == 2) // member functions
                {
                    ...
                    m_classPtr = FromLuaStack(context, method->GetArgument(0), nullptr, m_classPtrClass);
                }
                    ...
                    if (bindingTable.IsFunction(funcIndex))
                    {
                        ...
                        for (int iEvent = 0; iEvent < static_cast<int>(events.size()); ++iEvent)
                        {
                            ...
                            if (strcmp(fieldName, e.m_name) == 0)
                            {
                                ...
                                // result
                                userData->m_result = FromLuaStack(m_context, &e.m_parameters[0], nullptr, userData->m_resultClass);
        ...
        public:
            ...
            struct DefaultBehaviorCaller
            {
                static int Create(lua_State* lua)
                {
                    ...
                    size_t valueSize = 0;
                    //if( isUserStorageType )
                    //{
                    //    size_t getUserStorageSize   
                    //
                    //}
                ...
                static int Destroy(lua_State* lua)
                {
                    ...
                    if (userData->storageType != (u32)Script::Attributes::StorageType::RuntimeOwn)
                    {
                        ...
                        if (userData->storageType != (u32)Script::Attributes::StorageType::Value)
                        {
            ...
            void BindMethodOnStack(BehaviorContext* behaviorContext, BehaviorMethod* method)
            {
                ...
                LuaCaller* binder = CreateLuaCaller(behaviorContext, method);
                {
                    ...
                    if (method->HasResult())
                    {
                        ...
                        StringReplaceAll(resultName, "&", " ");
                        StringReplaceAll(resultName, "*", " ");
                        StringReplaceAll(resultName, "const ", "");
                        StringReplaceAll(resultName, " ", "");

                        functionName += "[=";
                        functionName += ValidateNameStr(resultName); // make sure the name is converted to a lua compatible name (so it looks as it will be called from Lua)
                        functionName += "]";
                    ...
                    for (size_t i = 0; i < method->GetNumArguments(); ++i)
                    {
                        ...
                        StringReplaceAll(paramName, "&", " ");
                        StringReplaceAll(paramName, "*", " ");
                        StringReplaceAll(paramName, "const ", "");
                        StringReplaceAll(paramName, " ", "");

                        functionName += ValidateNameStr(paramName); // make sure param name is converted to a lua compatible name (so it looks as it will be called from Lua)
                    ...
                    if (StringReplaceAll(functionName, "ScriptDataContext", "..."))
                    {
            ...
            /// We can move this to the string as extension, we return the number of occurances we replaced
            static size_t StringReplaceAll(AZStd::string& toReplace, const AZStd::string& search, const AZStd::string& replace)
            {
                size_t pos = 0;
            ...
            {
                AZStd::string newName = ValidateNameStr(source);
                if (newName != source)
                {
            ...
            AZStd::string ValidateNameStr(const AZStd::string& sourceName)
            {
                AZStd::string newName = sourceName;

                // remove common things like "allocator" and "AZStd::"
                StringReplaceAll(newName, "AZStd::", "");
                StringReplaceAll(newName, "allocator", "");

                // deal with *,&,<,>,etc.
                StringReplaceAll(newName, "*", "Ptr");
                //StringReplaceAll(newName, "&&", "Rval"); we don't support RValues in script
                StringReplaceAll(newName, "&", "Ref");
                StringReplaceAll(newName, "<", "_"); // template open
                StringReplaceAll(newName, ">", ""); // template close
                StringReplaceAll(newName, ",", "_"); // template or function parameters
                StringReplaceAll(newName, "::", "_"); // namespace

                // strip all other non alphanumeric or '_' characters
                newName.erase(AZStd::remove_if(newName.begin(), newName.end(),
                    [](AZStd::string::value_type ch)  {
                    return !AZStd::is_alnum(ch) && ch != '_';  // in lua we allow alpha numeric and '_'
                }), newName.end());
            ...
            void BindEBus(const char* ebusName, BehaviorEBus* ebus)
            {
                ...
                // handlers
                BehaviorClass* idClass = nullptr;
                LuaLoadFromStack idFromLua = FromLuaStack(m_context, &ebus->m_idParam, nullptr, idClass);
            ...
            bool LoadFromStream(IO::GenericStream* stream, const char* debugName, lua_State* lua)
            {
                LSV_BEGIN(m_lua, 1);
                ...
                if (lua_load(thread, LuaStreamReader, &userData, debugName) == 0)
                {
    ...
    ScriptContext::ScriptContext(IAllocatorAllocate* allocator, lua_State* nativeContext)
    {
    ...
    bool ScriptContext::LoadFromStream(IO::GenericStream* stream, const char* debugName, lua_State* thread)
    {
        return m_impl->LoadFromStream(stream, debugName, thread);
    }
