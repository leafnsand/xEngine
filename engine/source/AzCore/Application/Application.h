...
#ifndef AZCORE_APPLICATION_H
#define AZCORE_APPLICATION_H
...
namespace AZ
{
    ...
    public:
        ...
        public:
            ...
            static const char* GetPublicStoragePath();
        ...
        */
        ...
        const char* GetCdnRoot() const override { return m_cdnRoot; }
    ...
    protected:
        ...
        */
        ...
        char m_cdnRoot[AZ_MAX_PATH_LEN];
