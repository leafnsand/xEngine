...
*
*/
#ifndef AZCORE_GAMEENTITYCONTEXTCOMPONENT_H
#define AZCORE_GAMEENTITYCONTEXTCOMPONENT_H
...
namespace AZ
{
    ...
    public:
        ...
        SliceInstantiationTicket InstantiateDynamicSliceForBehaviorContext(const AZ::Data::Asset<AZ::Data::AssetData>& sliceAsset, const AZ::Transform& worldTransform) override;
        ...
        AZ::Entity* FindGameEntityById(AZ::EntityId entityId) override;
        BehaviorEntity FindGameEntityByIdForBehaviorContext(AZ::EntityId entityId) override;
        AZ::Entity* FindGameEntityByName(const char* name) override;
        BehaviorEntity FindGameEntityByNameForBehaviorContext(const char* name) override;
        //////////////////////////////////////////////////////////////////////////
...
#endif // AZCORE_GAMEENTITYCONTEXTCOMPONENT_H
