...
#include <AzCore/Component/EntityContext.h>
...
namespace AZ
{
    ...
    void GameEntityContextComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        if (AZ::BehaviorContext* behaviorContext = azrtti_cast<AZ::BehaviorContext*>(context))
        {
            behaviorContext->EBus<GameEntityContextRequestBus>("GameEntityContextRequestBus")
                ...
                ->Event("InstantiateDynamicSlice", &GameEntityContextRequestBus::Events::InstantiateDynamicSliceForBehaviorContext)
                ->Event("FindGameEntityById", &GameEntityContextRequestBus::Events::FindGameEntityByIdForBehaviorContext)
                ->Event("FindGameEntityByName", &GameEntityContextRequestBus::Events::FindGameEntityByNameForBehaviorContext)
                ;
        }
    }
    ...
    //=========================================================================
    // GameEntityContextRequestBus::InstantiateDynamicSliceForBehaviorContext
    //=========================================================================
    SliceInstantiationTicket GameEntityContextComponent::InstantiateDynamicSliceForBehaviorContext(const AZ::Data::Asset<AZ::Data::AssetData>& sliceAsset, const AZ::Transform& worldTransform)
    {
        if (sliceAsset.GetId().IsValid())
        {
            const SliceInstantiationTicket ticket = InstantiateSlice(sliceAsset, nullptr);
            if (ticket)
            {
    ...
    {
        if (AZ::EntityContext::LoadFromStream(stream, remapIds))
        {
    ...
    //=========================================================================
    // GameEntityContextRequestBus::FindGameEntityById
    //=========================================================================
    AZ::Entity* GameEntityContextComponent::FindGameEntityById(AZ::EntityId entityId)
    {
        AZ::Entity* result = nullptr;
        EBUS_EVENT_RESULT(result, AZ::ComponentApplicationBus, FindEntity, entityId);
        return result;
    }

    //=========================================================================
    // GameEntityContextRequestBus::FindGameEntityByIdForBehaviorContext
    //=========================================================================
    BehaviorEntity GameEntityContextComponent::FindGameEntityByIdForBehaviorContext(AZ::EntityId entityId)
    {
        AZ::Entity* result = nullptr;
        EBUS_EVENT_RESULT(result, AZ::ComponentApplicationBus, FindEntity, entityId);
        return BehaviorEntity(result);
    }

    //=========================================================================
    // GameEntityContextRequestBus::FindGameEntityByName
    //=========================================================================
    AZ::Entity* GameEntityContextComponent::FindGameEntityByName(const char* name)
    {
        AZ::Entity* result = nullptr;

        auto filter = [&](AZ::Entity* entity)
        {
        ...
        EBUS_EVENT(AZ::ComponentApplicationBus, EnumerateEntities, filter);

        return result;
    }

    //=========================================================================
    // GameEntityContextRequestBus::FindGameEntityByNameForBehaviorContext
    //=========================================================================
    BehaviorEntity GameEntityContextComponent::FindGameEntityByNameForBehaviorContext(const char* name)
    {
        AZ::Entity* result = nullptr;
    ...
    void GameEntityContextComponent::OnSlicePreInstantiate(const AZ::Data::AssetId& /*sliceAssetId*/, const AZ::SliceComponent::SliceInstanceAddress& sliceAddress)
    {
        ...
        if (instantiatingIter != m_instantiatingDynamicSlices.end())
        {
            ...
            for (AZ::Entity* entity : entities)
            {
                auto* transformComponent = entity->FindComponent<AZ::TransformComponent>();
