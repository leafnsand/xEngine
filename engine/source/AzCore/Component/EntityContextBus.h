...
#ifndef AZCORE_ENTITYCONTEXTBUS_H
#define AZCORE_ENTITYCONTEXTBUS_H
...
namespace AZStd
{
     ...
     */
    template<>
    struct hash<AZ::SliceInstantiationTicket>
    {
        inline size_t operator()(const AZ::SliceInstantiationTicket& value) const
        {
            AZ::Crc32 crc;
...
#endif // AZCORE_ENTITYCONTEXTBUS_H
