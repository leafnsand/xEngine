    ...
    , m_requestedBytesPeak(0)
{
    ...
    SetCriticalSectionSpinCount(MemoryInternal::s_mutex.native_handle(), 4000);
#endif
...
{
    return MemoryInternal::s_mutex.try_lock();
}
