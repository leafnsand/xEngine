        ...
        static void Reflect(ReflectContext* context)
        {
            ...
            if (behaviorContext)
            {
                behaviorContext->Class<ContainerType>()
                    ...
                    ->Attribute(AZ::Script::Attributes::ConstructorOverride, &CustomConstructor)
                    ->Attribute(AZ::Script::Attributes::ReaderWriterOverride, ScriptContext::CustomReaderWriter(&ToLua, &FromLua))
                    ->Method("ToString", [](const ContainerType& stringView) { return stringView.to_string(); }, { { { "Reference" } } })
                    ...
                    ->Method("length", [](ContainerType* thisPtr) { return aznumeric_cast<int>(thisPtr->length()); }, { { { "This" } } })
                    ->Attribute(AZ::Script::Attributes::ToolTip, "Returns length of string view")
                    ->Attribute(AZ::Script::Attributes::Operator, AZ::Script::Attributes::OperatorType::Length)
                    ->Method("size", [](ContainerType* thisPtr) { return aznumeric_cast<int>(thisPtr->size()); }, { { { "This" }} })
                    ->Attribute(AZ::Script::Attributes::ToolTip, "Returns length of string view")
        ...
        static void Reflect(ReflectContext* context)
        {
            ...
            if (behaviorContext)
            {
                ...
                behaviorContext->Class<ContainerType>()
                    ...
                    ->template Method<typename ContainerType::reference(ContainerType::*)(typename ContainerType::size_type)>("at", &ContainerType::at, {{ { "Index", nullptr, BehaviorParameter::Traits::TR_INDEX } }})
                        ->Attribute(AZ::Script::Attributes::Operator, AZ::Script::Attributes::OperatorType::IndexRead)
                    ->Method("insert", &Insert, {{ {}, { "Index", nullptr, BehaviorParameter::Traits::TR_INDEX } }})
