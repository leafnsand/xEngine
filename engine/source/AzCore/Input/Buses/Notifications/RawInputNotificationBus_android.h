...
namespace AZ
{
    ...
    //! that want android events to be processed by the AZ input system must broadcast all
    ...
    //!
    //! This EBus is intended primarily for the AZ input system to process raw input events.
