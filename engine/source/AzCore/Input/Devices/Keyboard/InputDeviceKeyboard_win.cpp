...
#include <AzCore/Input/Devices/Keyboard/InputDeviceKeyboard_win_common.inl>
...
namespace AZ
{
    ...
    private:
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::RawInputNotificationsWin::OnRawInputEvent
        void OnRawInputEvent(const RAWINPUT& rawInput) override;

        ////////////////////////////////////////////////////////////////////////////////////////////
        //! \ref AZ::RawInputNotificationsWin::OnRawInputCodeUnitUTF16Event
