...
#include <AzCore/Input/Events/InputChannelEventSink.h>
...
{
    AZ::InputDeviceVirtualKeyboard::Implementation* m_inputDevice;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
- (id)initWithInputDevice: (AZ::InputDeviceVirtualKeyboard::Implementation*)inputDevice;
                        ...
                        reason: (UITextFieldDidEndEditingReason)reason
{
    ...
    m_inputDevice->QueueRawCommandEvent(AZ::InputDeviceVirtualKeyboard::Command::EditEnter);
...
- (BOOL)textFieldShouldClear: (UITextField*)textField
{
    ...
    m_inputDevice->QueueRawCommandEvent(AZ::InputDeviceVirtualKeyboard::Command::EditClear);
