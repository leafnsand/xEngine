...
#ifndef AZCORE_APPLICATIONAPI_H
#define AZCORE_APPLICATIONAPI_H
...
#include <AzCore/CommandLine/CommandLine.h>
...
namespace AZ
{
    ...
    public:
        ...
        /// Retrieves the cdn root path for the application.
        virtual const char* GetCdnRoot() const { return nullptr; }
    ...
    public:
        ...
        // AzCore::Application listens for all the system specific
