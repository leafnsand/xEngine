    ...
    _agent(nullptr)
{
    ...
    _agent->addEventListener(UIEventType::DragEnd, FUI_CALLBACK_1(DragDropManager::onDragEnd, this));
}

DragDropManager::~DragDropManager()
{
    FUI_SAFE_RELEASE(_agent);
}
...
void DragDropManager::startDrag(const AZStd::string & icon, const Value& sourceData, int touchPointID)
{
